...
class MotorControllerNode:
    ...
    def callback(self, msg):
        self.calibrated = [
            1.0 * msg.data[0] / 7.53 * 48,
            1.0 * msg.data[1] / 7.53 * 48,
            1.27 * msg.data[2] / 7.53 * 48,
            1.0 * msg.data[3] / 7.53 * 48,
        ]
...
if __name__ == "__main__":
    ...
    rospy.Subscriber("/velocity", Float64MultiArray, motor_ctrl_node.callback, queue_size=10)
    rospy.spin()